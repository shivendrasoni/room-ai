...
```bash
git clone https://github.com/shivendrasoni/room-ai
```
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/shivendrasoni/room-ai&env=REPLICATE_API_KEY&project-name=room-GPT&repo-name=roomGPT)
